...
from app.routers.characters.common import _serialize_char, router, xp_to_next
from app.schemas import CharacterCreate, EffectCreate, ModifierCreate, TimerCreate
...
async def level_up(char_id: int, body: dict | None = None, db: AsyncSession = Depends(get_session)):
    ...
    from app.game_mechanics import RANK_ORDER, RANK_PROGRESSION
    from app.models import Race, RaceRankConfig
    from app.websocket_manager import manager as _ws
    ...
    if choice == "attributes":
        ...
        from app.models import AbilityLevelConfig as _ALC
        from app.models import AbilityRankConfig as _ARC
        ...
        try:
            from app.routers.abilities import _apply_resolved_passive_bonuses, _remove_passive_bonuses, _resolve_ability
